...
import { getMarketShare, getTopProducers } from "@/lib/filters";
import type { TobaccoProduction } from "@/lib/types";

const RankingBarChart = dynamic(() => import("@/components/charts/ranking-bar-chart").then((m) => m.RankingBarChart), { ssr: false });
const MarketSharePieChart = dynamic(() => import("@/components/charts/market-share-pie-chart").then((m) => m.MarketSharePieChart), { ssr: false });
