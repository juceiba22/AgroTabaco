...
import { coberturaByYear, coberturaStats } from "@/lib/filters";
import type { PoaTabaco } from "@/lib/types";

const CoberturaChart = dynamic(() => import("@/components/charts/cobertura-chart").then((m) => m.CoberturaChart), { ssr: false });
