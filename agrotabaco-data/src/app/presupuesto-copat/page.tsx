...
import { ProposalActions } from "./print-button";
...
export default function PresupuestoCopatPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl pb-16 pt-2">
      ...
      <div className="executive-header relative overflow-hidden rounded-2xl p-6 sm:p-9">
      ...
      {/* Pie membretado para impresión */}
      <div className="mt-12 hidden border-t border-border/80 pt-6 text-xs text-muted-foreground print:block">
        <div className="flex justify-between">
          <span>AgroTabaco · Inteligencia, Finanzas y Comunicación Sectorial</span>
          <span>agrotabaco.com</span>
        </div>
      </div>
    </div>
  );
