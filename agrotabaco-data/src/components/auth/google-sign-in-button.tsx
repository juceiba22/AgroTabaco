  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <button
        onClick={handleClick}
        disabled={loading}
        className="inline-flex items-center gap-2 rounded-lg border border-border bg-white px-5 py-2.5 text-sm font-semibold text-foreground shadow-sm transition-colors hover:bg-brand-gray disabled:opacity-60"
      >
        <svg viewBox="0 0 24 24" className="size-4" aria-hidden="true">
          ...
          <path
            fill="#FBBC05"
            d="M5.27 14.29c-.25-.72-.38-1.49-.38-2.29s.14-1.57.38-2.29V6.62H1.29A11.9 11.9 0 0 0 0 12c0 1.92.46 3.74 1.29 5.38z"
          />
          <path
            fill="#EA4335"
