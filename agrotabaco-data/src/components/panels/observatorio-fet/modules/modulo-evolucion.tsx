...
import { usdSeriesByYear } from "@/lib/panels/observatorio-fet/filters";
import type { PoaTabaco } from "@/lib/panels/observatorio-fet/types";

const UsdEvolutionChart = dynamic(() => import("@/components/panels/observatorio-fet/charts/usd-evolution-chart").then((m) => m.UsdEvolutionChart), {
  ssr: false,
});
