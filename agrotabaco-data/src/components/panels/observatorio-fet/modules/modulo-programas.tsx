...
import { breakdownByObjetoPrograma, topComponentes } from "@/lib/panels/observatorio-fet/filters";
import type { PoaTabaco } from "@/lib/panels/observatorio-fet/types";

const ProgramaDonutChart = dynamic(() => import("@/components/panels/observatorio-fet/charts/programa-donut-chart").then((m) => m.ProgramaDonutChart), {
  ssr: false,
});
