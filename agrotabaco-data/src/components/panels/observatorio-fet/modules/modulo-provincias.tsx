...
import { rankingByProvincia } from "@/lib/panels/observatorio-fet/filters";
import type { PoaTabaco } from "@/lib/panels/observatorio-fet/types";

const ProvinciaRankingChart = dynamic(
  () => import("@/components/panels/observatorio-fet/charts/provincia-ranking-chart").then((m) => m.ProvinciaRankingChart),
  { ssr: false }
);
