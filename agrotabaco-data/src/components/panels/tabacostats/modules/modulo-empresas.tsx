...
import type { AcopioEmpresa } from "@/lib/panels/tabacostats/types";

const CompaniesHorizontalBarChart = dynamic(
  () => import("@/components/panels/tabacostats/charts/companies-horizontal-bar-chart").then((m) => m.CompaniesHorizontalBarChart),
  { ssr: false }
);
