...
import { cleanResolucionLabel, sortCampanasGuionDesc, sum } from "@/lib/panels/tabacostats/filters";
import type { PrecioResolucion } from "@/lib/panels/tabacostats/types";

const PrecioFetAreaChart = dynamic(
  () => import("@/components/panels/tabacostats/charts/precio-fet-area-chart").then((m) => m.PrecioFetAreaChart),
  { ssr: false }
);
const PrecioFetComparativoChart = dynamic(
  () => import("@/components/panels/tabacostats/charts/precio-fet-comparativo-chart").then((m) => m.PrecioFetComparativoChart),
  { ssr: false }
);
