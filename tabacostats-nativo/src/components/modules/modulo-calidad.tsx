...
import { CampanaProvinciaVariedadFilter } from "@/components/filters/campana-provincia-variedad-filter";
import { ClasesMultiselect } from "@/components/filters/clases-multiselect";
import {
  Select,
  SelectContent,
  SelectItem,
...
import type { AcopioClase } from "@/lib/types";

const ClassesGroupedBarChart = dynamic(
  () => import("@/components/charts/classes-grouped-bar-chart").then((m) => m.ClassesGroupedBarChart),
  { ssr: false }
);
